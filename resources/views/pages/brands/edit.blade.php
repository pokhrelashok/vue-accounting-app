		...
		<div id="accordion">
			<div class="card">
				<div class="card-header bg-secondary" id="headingOne">
					<h5 class="mb-0">
						<a class="btn btn-secondary" href="{{ action('BrandController@index') }}">
									...
									<div class="form-group ">
										...
										<div class="col-md-12">
											<input id="name" type="text"
												...
												value="{{ $brand->name }}" required autocomplete="off" autofocus>
									...
									<div class="form-group ">
										...
										<div class="col-md-12">
											<input id="phone" type="text"
												...
												value="{{  $brand->phone }}" required autocomplete="off" autofocus>
									...
									<div class="form-group ">
										...
										<div class="col-md-12">
											<input id="email" type="text"
												...
												value="{{ $brand->email }}" autocomplete="off" autofocus>
									...
									<div class="form-group ">
										...
										<div class="col-md-12">
											<input id="address" type="text"
												...
												name="address" value="{{  $brand->address }}" required
