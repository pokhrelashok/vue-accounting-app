    ...
    <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group text-right">
                                        <button class="btn btn-success">Add New Supplier</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div class="card mt-4">
            <div class="card-header">
                <h5>All Suppliers ({{ $suppliers->count() }})</h5>
            </div>
            <div class="card-bpdy">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-danger"><strong>
                                    {{  ($supplier->accounts()->latest()->get())[0]->balance ?? 0 }}</strong>
                            </td>
                            ...
                            <td>
                                <form method="post" action="{{ action('SupplierController@destroy', $supplier->id) }}">
                                    ...
                                    <a class="btn btn-sm btn-secondary"
                                        href="{{ action('SupplierController@show', $supplier->id) }}">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a class="btn btn-sm btn-secondary"
                                        href="{{ action('SupplierController@edit', $supplier->id) }}">
